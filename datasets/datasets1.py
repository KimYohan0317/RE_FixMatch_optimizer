...
class LoadDataset_Label_Unlabel(object):
    def __init__(self, params):
        ...
        assert self.name in ['CIFAR10', 'CIFAR100' ,'FashionMNIST'], f"[!] Dataset Name is wrong, \
                                                            expected: CIFAR10, CIFAR100, FashionMNIST  \
                                                            received: {self.name }"
    ...
    def get_dataset(self):
        ...
        if self.name == "FashionMNIST":
            data_dir = os.path.join(rootdir, self.datapath, 'fminst-batches-py')
